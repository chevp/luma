...
function frontmatter(id, type, title) {
...
export function makePlanCreateTool(cwd) {
    return tool("plan_create", "Create a new framework plan file (CTX/EXP/PRD/PROP/ADR) under context/plans/ or context/adr/. Returns the path of the new file.", {
...
export function makePlanListTool(cwd) {
    return tool("plan_list", "List existing framework plan files under context/plans/ and context/adr/. Optionally filter by type.", {
...
//# sourceMappingURL=chi-plan.js.map