...
export async function installViaWinget(id: string): Promise<boolean> {
...
export async function installViaBrew(id: string, cask = false): Promise<boolean> {
...
export async function installViaApt(pkgs: string[]): Promise<boolean> {
